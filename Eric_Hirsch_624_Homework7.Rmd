...
```{r}
m10
co <- as.data.frame(as.matrix(m10["beta"]))
m10["beta"]["x"]
coef(m10)
```
...
dfGo <- dfChem2 %>%
  dplyr::select(BiologicalMaterial05, BiologicalMaterial07, BiologicalMaterial09, ManufacturingProcess18, ManufacturingProcess30, Yield)
