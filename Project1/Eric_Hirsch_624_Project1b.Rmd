...
2. We will train the model on 75% of the data.
...
fit <- train1 %>%
  model(ETS(KWH ~ error("N") + trend("M") + season("N")))
...
fc %>% forecast::autoplot(ts) + labs(title = paste(ATM, ", Training Data is <= January"))
