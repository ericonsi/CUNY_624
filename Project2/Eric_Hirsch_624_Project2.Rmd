...
dfPH4 <- EHPrepare_RemoveRecordsByRowNumber(dfPH3q, c(1094, 690, 2359)) 
...
The table below shows results for the 11 algorithms.  Random Forest is clearly the best performer.

It should be noted that R-Squareds were .05 higher for several agorithms when PH underwent a boxcox transformation.  However, this was not worth the difficulty of interpretability.

```{r}

tab <- matrix(c("OLS Regression", .136, .43, "Lasso", .133, .43, "Ridge", .134, .43, "KNN", .125, .50, "NeuralNet", .120, .54, "MARS", .131, .45, "SVM-Linear", .134, .42,"SVM_Radial",.117,.56, "Random Forest", .099, .72, "Boosted", .106, .64, "Cubist", .133, .49), ncol=3, byrow=TRUE) 
